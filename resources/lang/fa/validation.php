...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'color' => 'رنگ',
        'description' => 'توضیحات',
        'lead_category_id' => 'دسته بندی سرنخ',
        'lead_resource_id' => 'منبع سرنخ',
        'lead_status_id' => 'وضعیت سرنخ',
        'lead_industry_id' => 'نوع صنعت سرنخ',
        'lead_type_id' => 'نوع سرنخ',
        'country_id' => 'کشور',
        'province_id' => 'استان',
        'city_id' => 'شهر',
        'note' => 'یادداشت',
        'campaign_id' => 'کمپین',
        'campaign_status_id' => 'وضعیت کمپین',
        'campaign_type_id' => 'نوع کمپین',
        'start_date' => 'تاریخ شروع',
        'end_date' => 'تاریخ پایان',
        'desired_end_date' => 'تاریخ قابل انتظار پایان',
        'to_id' => 'انتخاب کاربر'
